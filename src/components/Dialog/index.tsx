...
const Index: React.FC<RequireOne> = (props) => {
  ...
  const { title, message, children, visible: visibleProps, onAnimationend } = props
  ...
  return visible
    ? <div ref={wrapperEl}
      className={classnames(scss.container, 'animate__animated', visibleProps ? 'animate__fadeIn' : 'animate__fadeOut')}>
      <div className={classnames(scss.dialog, 'animate__animated', visibleProps ? 'animate__zoomIn' : 'animate__zoomOut')}>
